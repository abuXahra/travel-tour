...
import {
  ...
  ButtonWrapper,
  ContactDetail,
  // HotelDetailWrapper, HotelGuestInfoContent, HotelGutestDetailBody, HotelGutestDetailClass, HotelGutestDetailTitle, HotelGutestDetailWrapper,
  TaxiSuccessBody,
  TaxiSuccessContent,
  TaxiSuccessHeader,
  TaxiSuccessWrapper,
  // HotelTripAirport, HotelTripDetailTime, HotelTripHour,
  HRStyled,
  MarkIcon,
  ...
  ContainerHeader,
  Containerbody,
} from "./TaxiSuccess.style";
import {
  // IoIosArrowDown,
  IoMdCheckmark,
} from "react-icons/io";
import Button from "../../../components/button/Button";
import // TripAirport, TripDetailBody, TripDetailClass, TripDetailTile, TripDetailTime, TripHour
"../../flight/flight_result/trip_info/TripInfo.style";
import FlightIcon from "../../../components/flight_icon/FlightIcon";
import {
  MdFlightLand,
  // , MdHotel, MdLocalHotel
} from "react-icons/md";
...
export default function TaxiSuccess() {
  ...
  return (
    <TaxiSuccessWrapper>
      {/* Header */}
      <TaxiSuccessHeader></TaxiSuccessHeader>
      ...
      <TaxiSuccessBody>
        <TaxiSuccessContent>
          <SuccessWrapper>
            ...
            <p>
              Your reservation has been placed successfully. we will send you a
              confirmation <br />
        ...
        <TaxiSuccessContent id="printable-div">
          ...
          <FlightContainer>
            ...
            <FlightIconWrapper>
              ...
              <FaLocationDot />
              <p>
                1099 First Ave, Wuse, Abuja 900103, Federal Capital Territory
              </p>
            </FlightIconWrapper>
              ...
              <ContainerWrapper>
                ...
                <Containerbody wd={"100%"}>
                  <div>
                    ...
                    <span>
                      <MdFlightLand /> Nnamdi Azikiwe International Airport,
                ...
                <Containerbody wd={"100%"}>
                  <div>
                    ...
                    <span>
                      <FaLocationDot /> Adamawa House, 1099 First Ave, Wuse,
              ...
              <ContainerWrapper>
                ...
                <Containerbody wd={"100%"}>
                  <div>
                    ...
                    <span>
                      50% cancellation fee applies for less than 24 hours before
                      pick time
                    </span>
                  </div>
                </Containerbody>
