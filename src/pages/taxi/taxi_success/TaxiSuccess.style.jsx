...
export const TaxiSuccessWrapper = styled.div`
    width: 100%;
    display: flex;
...
export const TaxiSuccessHeader = styled.div`
    height: 250px;
    padding: 20px;
    width: 100%;
...
export const TaxiSuccessHeaderItems = styled.div`
    width: 100%;
    display: flex;
    /* gap: 30px; */
    padding: 30px;
...
export const TaxiSuccessHeaderTitle = styled.div`
        display: flex;
        gap: 30px;
        align-items: center;
...
export const TaxiSuccessBody = styled.div`
    width: 100%;
    margin-top: -200px;
    display: flex;
...
export const TaxiSuccessContent = styled.div`
      width: ${({ wd }) => wd || "85%"};
      display: flex;
      flex-direction: column;
      gap: 20px;
