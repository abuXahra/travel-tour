...
export default function DropOffCustomization() {
    ...
    <TaxiCustomizationWrapper>        
        ...
        <TaxiCustomizationHeaderItems >
            <TaxiCustomizationHeaderTitle>
                <span><Button text={'Back'} onClick={()=>navigate('/drop-off-detail')}/></span>
        ...
        <TaxiCustomizationBody>
             ...
             <TaxiCustomizationSideBar>
                  <TaxiCustomizationSideContent>
                    ...
                    <div>
                          <p><b>Drop-off</b></p> 
                          <p>Nnamdi Azikwe International Airport </p>
                        </div>
                    </span>
                    </SideFlightAirport>
            ...
            <TaxiCustomizationContent>
              ...
              <TaxiCustomizationWrapperb>
               {/* title */}
                  ...
                  <span> <h2>Gwarimpa</h2> <FlightIcon Icon={<FaCarSide/>} rotate={'360'} iconColor={'#0D3984'}/>  <h2>Nnamdi Azikiwe Airport</h2> </span>
                    <span>
                      <p>5th, Aug 2024</p>
                      <p>08:00am</p>
                      <div>
              ...
              {showBookingDetail &&
                <TripDetailBody>
                  <TripDetailWrapper>
                    ...
                    <span onClick={()=>navigate('/dropoff-edit/#dropoff-edit-form')}><FaEdit/></span>
                  </TripDetailWrapper>
                  <TripDetailWrapper>
                    <CustomizeTripDetail>
                    ...
                    <span onClick={()=>navigate('/dropoff-edit/#dropoff-edit-form')}><FaEdit/></span>  
                        ...
                        <ButtonWrapper>
                    <Button text={"Continue"} onClick={()=>navigate('/dropoff-overview')}/>
                </ButtonWrapper>   
                </TaxiCustomizationContent>
            </TripMinContent>
        </TaxiCustomizationBody>
