...
export const TaxiCustomizationWrapper  = styled.div`
    width: 100%;
    display: flex;
...
export const TaxiCustomizationHeader = styled.div`
    height: 300px;
    width: 100%;
...
export const TaxiCustomizationHeaderItems = styled.div`
    width: 100%;
    display: flex;
    /* gap: 30px; */
    padding: 30px;
...
export const  TaxiCustomizationHeaderTitle = styled.div`
        display: flex;
        gap: 30px;
        align-items: center;
...
export const TaxiCustomizationBody = styled.div`
    width: 100%;
    margin-top: -220px;
    display: flex;
    gap: 20px;
...
// SIDEBAR
export const TaxiCustomizationSideBar = styled.div`
   width: 25%;
    height: auto;
    display: flex;
    flex-direction: column;
...
export const TaxiCustomizationSideContent = styled.div`
    width: 100%;
    height: auto;
    display: flex;
    flex-direction: column;
...
export const TaxiCustomizationContent =styled.div`
      width: 100%;
      display: flex;
      flex-direction: column;
      gap: 20px;
...
export const TaxiCustomizationWrapperb =styled.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    background-color: #0d398420;
