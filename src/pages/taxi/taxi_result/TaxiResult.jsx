...
// import { facilities } from '../../../data/object/hotel_sidebar_list/HotelSideBarList';
...
import {
  ...
  CabTypeList,
  TaxiResultList,
} from "../../../data/object/TaxiResultList";
...
export default function TaxiResult() {
  ...
  const [dropOff, setDropOff] = useState("Garki");
  const [pickup, setPickup] = useState("Abuja");
  ...
  {/* Taxi Class */}
          <SideBarContent>
            ...
            {CabClassList.map((item, i) => (
              <SidebarItems key={i} value={item.title} counter={item.counter} />
            ))}
          </SideBarContent>
        </ResultSidebar>
