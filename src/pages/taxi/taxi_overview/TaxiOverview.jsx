...
import {
  FaCarSide,
  // , FaCheckCircle, FaCircle, FaPaypal, FaTimes
} from "react-icons/fa";
        ...
        <OverviewHeaderItems>
          <OverviewHeaderTitle>
            <span>
              <Button
                text={"Back"}
                onClick={() => navigate("/taxi-customization")}
              />
            </span>
        ...
        <OverviewContent>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <AgreeWrapper>
              ...
              <span>*</span>
              <p>
                I have read and accept the <span>terms and conditions</span> of
                Manzo Taxi Booking.
              </p>
            </AgreeWrapper>
            ...
            <ButtonWrapper>
              ...
              <Button
                ...
                onClick={() => setConfirmPayPopup(true)}
              />
            </ButtonWrapper>
          </form>
        </OverviewContent>
