...
import {
  ...
  // FlightDetailWrapper,
  FormContent,
  // FormWrapper, PromoHeader, PromoInput, PromoWrapper,
  SideFlightAirport,
  SideFlightSummary,
  // TotalFare,
  TotalTrip,
...
import // ErrorMessage
"../../flight/flight_overview/FlightOverview.style";
import TaxiTimeline from "../../../components/timeline/TaxiTimline";

export default function TaxiEdit() {
  // navigation
  ...
  const handledSubmit = (e) => {
    ...
    } else if (dropOffName === "" || null) {
      setDropOffNameError(true);
    } else if (!selectedTitleValue) {
    ...
    <TaxiEditWrapper>
      ...
      <TaxiEditHeader>
        <TaxiEditHeaderItems>
          <TaxiEditHeaderTitle>
            <span>
              <Button text={"Back"} onClick={() => navigate("/taxi-detail")} />
            </span>
      ...
      <TaxiEditBody>
        ...
        <TripMinContent>
          ...
          <TaxiEditContent>
            ...
            <p>
              Driver and Taxi detail will sent after confirmation of the booking
            </p>
          </TaxiEditContent>
            ...
            <ChargesWrapper>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Additional fees for locations beyond the specified address
                  </li>
                </ul>
              </div>
            </ChargesWrapper>
