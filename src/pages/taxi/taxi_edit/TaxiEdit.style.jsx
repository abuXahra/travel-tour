...
export const TaxiEditWrapper  = styled.div`
    width: 100%;
    display: flex;
...
export const TaxiEditHeader = styled.div`
    height: 300px;
    width: 100%;
...
export const TaxiEditHeaderItems = styled.div`
    width: 100%;
    display: flex;
    /* gap: 30px; */
    padding: 30px;
...
export const  TaxiEditHeaderTitle = styled.div`
        display: flex;
        gap: 30px;
        align-items: center;
...
export const TaxiEditBody = styled.div`
    width: 100%;
    margin-top: -220px;
    display: flex;
    gap: 20px;
...
// SIDEBAR
export const TaxiEditSideBar = styled.div`
   width: 25%;
    height: auto;
    display: flex;
    flex-direction: column;
...
export const TaxiEditSideContent = styled.div`
    width: 100%;
    height: auto;
    display: flex;
    flex-direction: column;
...
export const TaxiEditContent =styled.div`
      width: 100%;
      display: flex;
      flex-direction: column;
      gap: 20px;
...
export const TaxiEditWrapperb =styled.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    background-color: #0d398420;
