...
export default function TaxiDropOffDetail() {
  ...
  // firstname variable
  const [pickupName, setPickupName] = useState('B close, 3rd Avenue Gwarimpa Abuja');
    ...
    <TaxiDetailWrapper>        
        ...
        <TaxiDetailHeaderItems >
            <TaxiDetailHeaderTitle>
                <span><Button text={'Back'} onClick={()=>navigate('/drop-off-result')}/></span>
