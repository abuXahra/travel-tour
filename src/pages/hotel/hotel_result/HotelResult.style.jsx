...
export const HotelResultWrapper = styled.div`
    width: 100%;
    display: flex;
...
export const HotelResultHeader = styled.div`
    width: 100%;
    display: flex;
    flex-direction: column;
    align-items: start;
...
export const HotelResultContent = styled.div`
    width: 100%;
    display: flex;
...
export const HotelResultMain = styled.div`
    width: 70%;
    height: auto;
    display: flex;
    flex-direction: column;
