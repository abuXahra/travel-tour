...
import {
  ...
  SuccessWrapper,
  // VissaGuestInfoContent, VissaGutestDetailBody, VissaGutestDetailClass, VissaGutestDetailTitle, VissaGutestDetailWrapper,
  VissaSuccessBody,
  VissaSuccessContent,
  VissaSuccessHeader,
  VissaSuccessWrapper,
  // , VissaTripAirport, VissaTripDetailTime, VissaTripHour
...
import {
  ...
  UserVisaDataWrapper,
  VisaDataImg,
} from "../../../components/visa/UserVisaData.style";
      ...
      <VissaSuccessBody>
        <VissaSuccessContent>
          <SuccessWrapper>
            ...
            <p>
              Your Visa Application has been placed successfully. we will send
              you a confirmation <br />
              email with your application details
            </p>
            <BookingId>
              <span>
                Application ID: <b>{bookId}</b>{" "}
              </span>{" "}
