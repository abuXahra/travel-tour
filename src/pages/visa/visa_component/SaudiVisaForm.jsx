...
import {
  ButtonWrapper,
  FormContent,
} from "../../flight/flight_customization/FlightCustomization.style";
...
export default function SaudiVisaForm({
  visaData,
  setVisaData,
  setShowSaudiVisa,
  setShowSaudiVisaData,
}) {
  ...
  const handledSubmit = (e) => {
    ...
    // phone validation
      ...
      setVisaNoError(true);
    } else if (passportNo === "" || null) {
      setPassportNoError(true);
    } else if (placeIssued === "" || null) {
