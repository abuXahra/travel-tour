...
import { CloseIcon, ClosePopup, H3Styled, HRStyled, Section, VisaBody, VisaContentWrapper, VisaFormSection, VisaFormSectionContent, VisaFormSectionTitle, VisaWrapper } from "./Visa.style";
 ...
 <HeroSection heroImage={heroImage}>
    ...
    {/* Visa Body */}
     ...
     <PopupWrapper alignItems={'start'}>
        <PopupContent wd='70%'>
        <ClosePopup onClick={()=>setShowSaudiVisa(false)}><CloseIcon/></ClosePopup>
...
<PopupWrapper alignItems={'start'}>
        ...
        <PopupContent wd='70%'>
        <ClosePopup onClick={()=>setShowSaudiVisaData(false)}><CloseIcon/></ClosePopup>
...
{    showOtherVisa &&
     <PopupWrapper>
          <PopupContent wd='30%'>
          <ClosePopup onClick={()=>setShowOtherVisa(false)}><CloseIcon/></ClosePopup>
            <h3>Other Country Visa</h3>
            <p style={{fontSize: '13px', lineHeight: '20px'}}>Continue your other country visa application with our online agents </p>
            <div><Button text={'Chat with agent'} Icon={<FaWhatsapp/>} onClick={()=>{navigate('/hotel-reservation')}}/></div>
          </PopupContent>        
        </PopupWrapper>}
