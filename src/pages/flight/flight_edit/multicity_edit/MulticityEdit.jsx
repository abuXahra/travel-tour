...
export default function MulticityEdit() {
  ...
  <FlightDetailWrapper>
               {/* title */}
                  <TripDetailTile onClick={()=>setShowtripSecondDepart(!showtripSecondDepart)}>
                    <span> <h2>Lagos</h2> <FlightIcon rotate={'90deg'} iconColor={'#0D3984'}/>  <h2>Port Harourt</h2> </span>
                    <span>
                      <p>Saturday, July 13</p>
                      <p>0 Stops. 1h 15m</p>
                      <div>
                    ...
                    {  showtripSecondDepart &&
                     <TripDetailBody>
                        ...
                        <TripAirport>
                          <div>
                               <p><b>Lagos</b>.BOV, Nnamdi Azikwe International Ai...</p> 
                               <p>1h 15m</p>
                               <p><b>Port-Harcourt</b>.POH, Murtala Muhammed International...</p> 
                          </div>
                          <div>
                            <span><h4>BAGGAGE:</h4> <p>ADULT</p></span>
                            <span><h4>CHECK IN:</h4> <p>20KG</p> </span>
