...
import { MulitPassengerWrapper, MultiFlightPassengerClass, MultiFlightPassengerContent, MultiFlightPassengerWrapper, MultiPassengerContainer, PassengerContent, PassengerWrapper } from './MultiCityInput.style'
                ...
                <MultiFlightPassengerWrapper>
                    ...
                    <MultiPassengerContainer pWidth={pWidth}>
                        <MultiFlightPassengerClass  onClick={()=>setShowPassenger(!showPassenger)}>
                              <span>{totalPassenger} {totalPassenger === 1 ? 'Passenger': 'Passengers'}</span> <span><IoMdArrowDropdown/></span>
